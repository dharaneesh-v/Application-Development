...
const Header = () => {
  ...
  const { loginStatus, setLoginStatus, turfLoginStatus, setTurfLoginStatus } = useContext(MyContext);
    ...
    <header>
      <div className='container flex'>
        ...
        <div className='button flex'>
          {(loginStatus || turfLoginStatus) && !drawerOpen && (
            <IconButton
              size="large"
